let () =
  ...
  let p1 : App.project = (("Gadget", "succeed", 91) : App.project) in
  let p2 : App.project = (("Widget", "failed", 68) : App.project) in
  print_proj p1;
  print_proj p2;
  ...
  let negative_grade_proj: App.project = (("Thingamajig", "succeed", -10) : App.project) in
